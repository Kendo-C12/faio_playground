...
**Score per minute, not difficulty.** The 2025 qualification paid 10 points each for tasks 1, 2 and 3 — three pen-and-paper answers ([`task1_stats_101.md`](../faio-2025/qualification/task1_stats_101.md): mean/mode/median of ten listed numbers; [`task2_Probability_theory_101.md`](../faio-2025/qualification/task2_Probability_theory_101.md): $P(\text{at least one six in three rolls}) = 1 - (5/6)^3 = 0.4213$; [`task3_Medicine.md`](../faio-2025/qualification/task3_Medicine.md): Bayes, $0.01 \cdot 0.99 / (0.01 \cdot 0.99 + 0.99 \cdot 0.02) \approx 0.3333$). Each is two minutes with a calculator. 30 points for six minutes is a rate no modelling task can touch.
